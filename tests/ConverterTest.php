...
use Tdavis\PhantomMagick\Exception\FileFormatNotSupportedException;
use Aws\S3\S3Client;
...
class ConverterTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Tdavis\PhantomMagick\Converter', Converter::make('http://code-chunk.com'), 'Check Converter::make() method returning the instance of \Tdavis\PhantomMagick\Converter');
    }
